# Escrever uma função que solicita ao usuário uma senha e verifica se ela atende 
# a alguns critérios de segurança.
# Usar laço de repetição para rodar até uma senha válida ser informada e a mesma ser 
# informada duas vezes de
...
def receber_senha_valida():
    ...
    while senha_valida is False:
        ...
        # Variáveis para validar minusculas / maiusculas
        ...
        # Verifica se cada letra da senha aparece nas listas de letras minusculas e maiusculas
        ...
        # Verifica se achou tanto uma maiuscula quanto uma minuscula
