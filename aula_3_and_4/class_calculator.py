class Calculator:
    ...
    def somar(numero_1, numero_2):
        print(f'\33[032m A soma dos números é {numero_1 + numero_2}\33[0m')

    def subtrair(numero_1, numero_2):
        print(f'\33[032m A subtração dos números é {numero_1 - numero_2}\33[0m')

    def multiplicar(numero_1, numero_2):
        print(f'\33[032m A multiplicação dos números é {numero_1 * numero_2}\33[0m')

    def dividir(numero_1, numero_2):
        print(f'\33[032m A divisão dos números é {numero_1 / numero_2}\33[0m')
    
    def modulo(numero_1, numero_2):
        print(f'\33[032m O resto da divisão é {numero_1 % numero_2}\33[0m')
